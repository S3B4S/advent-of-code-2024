...
try {
  fileInput = Deno.readTextFileSync("./24_crossed-wires/input.txt");
} catch {
...
testWrapper("Day 24", () => {
  ...
  Deno.test("Part 1 - Example input 2", () => {
    expect(solvePart1(exmapleInput2)).toEqual(2024);
  });

  Deno.test("Part 1 - File input", () => {
    expect(solvePart1(fileInput)).toEqual(66055249060558);
  });
